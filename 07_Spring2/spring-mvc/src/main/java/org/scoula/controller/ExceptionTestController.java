...
public class ExceptionTestController {
    ...
    public String test(@RequestParam int age) throws IllegalAccessException {
        if (age < 0) {
            throw new IllegalAccessException("나이는 0보다 커야합니다.");
    ...
    * */
    ...
    public String handleIlligalArgument(IllegalArgumentException ex, Model model) {
        log.error("IllegalArgumentExcetpion 달성 =========> {}", ex.getMessage());
