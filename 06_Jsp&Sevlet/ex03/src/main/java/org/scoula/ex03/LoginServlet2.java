...
public class LoginServlet2 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // 2-1. jsp에 출력할 항목 설정 ==> jsp 파일을 forward할때 req, res객체 전달함.
        //     req객체에 전달할 항목으로 설정하면, jsp파일에 req객체와 함께 전달!
        req.setAttribute("userid", userid); //name은 항상 String, value는 항상 Object
        ...
        // 2-3. jsp파일을 호출(req, res전달)
        rd.forward(req, resp);
        //     2-1에게 request객체로 항목설정한 값이 따라감.
